                            ...
                            @foreach($contratos as $contrato)
                                ...
                                <tr class="expiry-contract-row {{ $enListaNegra ? 'blacklisted-worker' : '' }}"
                                    ...
                                    <td data-label="Dias">
                                        @if($hasLaterContract)
                                            @if($days === null)
                                                <span class="expiry-badge ok">Resuelto</span>
                                            @elseif($days < 0)
                                                <span class="expiry-badge ok">Resuelto hace {{ abs($days) }} dias</span>
                                            @elseif($days === 0)
                                                <span class="expiry-badge ok">Resuelto hoy</span>
                                            @else
                                                <span class="expiry-badge ok">Resuelto</span>
                                            @endif
                                        @elseif($days === null)
                                    ...
                                    <td data-label="Estado">
                                        ...
                                        @endif
                                        <div class="expiry-muted" style="margin-top:5px;">Laboral: {{ $contrato->getAttribute('estado_laboral_visual_label') ?: ucfirst(strtolower($personal?->estado ?: '-')) }}</div>
