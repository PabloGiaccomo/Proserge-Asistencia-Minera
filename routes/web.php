...
Route::middleware('web.auth')->group(function (): void {
    ...
    Route::get('/personal/antiguo/crear', [PersonalPageController::class, 'createAntiguo'])->middleware('web.permission:personal,crear')->name('personal.antiguo.create');
    Route::post('/personal/antiguo/crear', [PersonalPageController::class, 'storeAntiguo'])->middleware('web.permission:personal,crear')->name('personal.antiguo.store');
    ...
    Route::post('/personal/{id}/documentos/descargar', [PersonalDocumentoController::class, 'downloadSelected'])->middleware('web.permission:personal,ver')->name('personal.documentos.download-selected');
