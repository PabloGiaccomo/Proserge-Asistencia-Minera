...
CREATE TABLE IF NOT EXISTS personal (
  ...
  pendiente_contrato_firmado TINYINT(1) NOT NULL DEFAULT 0,
  en_lista_negra TINYINT(1) NOT NULL DEFAULT 0,
  lista_negra_motivo TEXT NULL,
  lista_negra_at TIMESTAMP NULL,
  lista_negra_by_usuario_id CHAR(36) NULL,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS epp_registro (
  ...
  vida_util_dias INT UNSIGNED NOT NULL DEFAULT 0,
