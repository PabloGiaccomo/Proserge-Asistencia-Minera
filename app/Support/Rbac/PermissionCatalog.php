...
class PermissionCatalog
{
    ...
    private const MODULE_ACTIONS = [
        ...
        'personal_ingresos' => ['ver', 'editar', 'actualizar', 'eliminar', 'aprobar', 'comunicar', 'ver_datos_sensibles'],
        ...
        'man_power' => ['ver', 'dashboards', 'crear', 'editar', 'actualizar', 'asignar', 'duplicar', 'administrar'],
        'logistica' => [
            'ver',
            'ver_logistica_dashboard',
            'ver_logistica_entregas',
        ...
        'transportes' => ['ver', 'crear', 'editar', 'actualizar', 'eliminar', 'entregar', 'recepcionar', 'duplicar', 'administrar'],
    ...
    public static function actionLabel(string $action): string
    {
        return match ($action) {
            ...
            'ver_todas_asistencias' => 'Ver y registrar todas las asistencias',
            'ver_desempeno' => 'Ver evaluación diaria',
            'evaluar_desempeno' => 'Realizar evaluación diaria',
            'ver_supervisores' => 'Ver evaluaciones de supervisores',
            'evaluar_supervisores' => 'Evaluar supervisores',
            'ver_residentes' => 'Ver evaluaciones de residentes',
            'evaluar_residentes' => 'Evaluar residentes',
        ...
        return [
            ...
            [
                ...
                'permisos' => self::matrixFromSelections([
                    ...
                    'man_power' => ['ver', 'dashboards', 'crear', 'editar', 'actualizar', 'asignar', 'duplicar'],
                    ...
                    'transportes' => ['ver', 'crear', 'editar', 'actualizar', 'entregar', 'recepcionar', 'duplicar'],
                ]),
            ],
            [
                'nombre' => 'RRHH',
