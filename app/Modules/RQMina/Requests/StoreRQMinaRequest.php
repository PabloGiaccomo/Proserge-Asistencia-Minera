...
class StoreRQMinaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'plan_id' => ['nullable', 'string', 'size:36', 'exists:rq_mina_planes,id'],
            ...
            'plan_operativo.*.transportes.*.fecha' => ['nullable', 'date'],
            'plan_operativo.*.transportes.*.turno' => ['nullable', 'string', 'in:A,B,DIA,NOCHE'],
            'plan_operativo.*.transportes.*.tipo_transporte' => ['nullable', 'string', 'in:PERSONAL,CARGA'],
            'plan_operativo.*.transportes.*.capacidad_requerida' => ['nullable', 'integer', 'min:0'],
            'plan_operativo.*.transportes.*.cantidad_unidades_requeridas' => ['nullable', 'integer', 'min:0'],
            'plan_operativo.*.transportes.*.origen' => ['nullable', 'string', 'in:EMPRESA,ALQUILADO,OTRO'],
            'plan_operativo.*.transportes.*.origen_snapshot' => ['nullable', 'string', 'max:191'],
            'plan_operativo.*.transportes.*.destino_snapshot' => ['nullable', 'string', 'max:191'],
            ...
            'plan_operativo.*.transportes.*.observaciones' => ['nullable', 'string'],
